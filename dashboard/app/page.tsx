    ...
    <main className="min-h-screen bg-[#050505] text-white selection:bg-gold-500/30">
      ...
      <section id="pricing" className="mx-auto max-w-6xl px-6 py-20">
            ...
            <div key={tier.name} className={`relative flex flex-col rounded-[2.5rem] bg-zinc-950 p-10 border ${tier.popular ? 'border-gold-500 shadow-[0_0_40px_-15px_rgba(212,175,55,0.3)]' : 'border-white/5'}`}>
              ...
              <a 
                href={tier.name === 'Sovereign' 
                  ? "mailto:ayman@elmahrosa.org?subject=Sovereign Deployment Inquiry" 
                  : `https://t.me/teoslinker_bot?start=${process.env.NEXT_PUBLIC_ALPHA_ACTIVATION_SECRET || 'activate_access'}`
                }
        ...
        <p className="mt-8 text-center text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-600">
          Alpha pricing — subject to change without notice
        </p>
      </section>
