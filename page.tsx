      ...
      <section id="demo" className="section" style={{ textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div className="container" style={{ position: "relative" }}>
          ...
          <p style={{ marginTop: 32, fontSize: 14, color: "#3d5266" }}>
            ...
            <a href={TELEGRAM_URL} target="_blank" rel="noopener noreferrer" style={{ color: "#22c55e", fontWeight: 600 }}>
        ...
        <div className="container">
          <div className="footer-grid">
            <div>
              ...
              <a href={`mailto:${CONTACT_EMAIL}`} style={{ fontSize: 13, color: "#3d5266", textDecoration: "underline" }}>
                {CONTACT_EMAIL}
              </a>
            </div>
