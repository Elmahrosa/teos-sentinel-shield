...
const { printStartupBanner, getVersion } = require('../../lib/version');
...
if (require.main === module) {
  app.listen(PORT, () => {
    log('info', `TEOS Sentinel Engine v${getVersion().version} started`, { port: PORT, env: NODE_ENV, store: process.env.REDIS_URL ? 'redis' : 'memory' });
  });
}
