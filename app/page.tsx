...
.feat {
  background: var(--deep); padding: 44px;
...
.pop-badge {
  ...
  letter-spacing: 0.12em; padding: 4px 14px; border-radius: 2px;
  white-space: nowrap;
}
...
.plan-feats li::before {
  content: '→';
  color: var(--gold-dim); font-size: 12px; flex-shrink: 0;
}
...
.sovereign-copy h2 {
  font-family: 'Fraunces', serif;
  font-weight: 900; font-size: clamp(28px, 3.5vw, 50px);
...
.rm-dot {
  ...
  border-radius: 50%; background: var(--scan-green);
...
@media (max-width: 1024px) {
  ...
  .terminal-section, .flow-section, .features-section,
  .compare-section, .pricing-section, .roadmap-section,
  .sovereign-section, .final-cta { padding-left: 32px; padding-right: 32px; }
...
<div class="threat-ticker" aria-hidden="true">
  <div class="ticker-inner" id="ticker">
    ...
    <span class="tick-item" style="color:var(--scan-green)">✅ ALLOWED</span><span class="tick-label">console.log("hello") · R00.CLEAN · Score 0/100</span>
    ...
    <span class="tick-item" style="color:var(--scan-green)">✅ ALLOWED</span><span class="tick-label">npm install lodash · R00.CLEAN · Score 0/100</span>
  ...
  <div class="features-inner">
    ...
    <div class="features-grid reveal">
      <div class="feat">
        ...
        <div class="feat-tags">
          <span class="ftag">rm -rf</span>
          <span class="ftag">eval()</span>
          <span class="ftag">curl|bash</span>
          <span class="ftag">DROP TABLE</span>
          <span class="ftag">sudo</span>
          <span class="ftag">chmod 777</span>
        </div>
      </div>
      ...
      <div class="feat">
        ...
        <p class="feat-desc">Scans npm manifests against 14+ known compromised packages — including event-stream (Bitcoin wallet attack), ua-parser-js (crypto miner), node-ipc (protestware), and more. Pre-install. Not post-incident.</p>
        <div class="feat-tags">
          <span class="ftag">event-stream</span>
          <span class="ftag">node-ipc</span>
          <span class="ftag">ua-parser-js</span>
          <span class="ftag">lodash CVE</span>
        </div>
      </div>
      ...
      <div class="feat">
        ...
        <div class="feat-tags">
          <span class="ftag">write-all</span>
          <span class="ftag">secrets</span>
          <span class="ftag">--privileged</span>
          <span class="ftag">curl|bash</span>
        </div>
      </div>
      ...
      <div class="feat">
        ...
        <div class="feat-tags">
          <span class="ftag">zero-signup</span>
          <span class="ftag">5 free scans</span>
          <span class="ftag">instant</span>
        </div>
      </div>
      ...
      <div class="feat">
        ...
        <p class="feat-desc">Scan credits are tracked per user. Credits consumed only on clean passes — blocked threats don't cost you. Upgrade tiers unlock higher limits and advanced scanners. Full audit logs for compliance teams.</p>
        <div class="feat-tags">
          <span class="ftag">per-scan tracking</span>
          <span class="ftag">auto credits</span>
          <span class="ftag">audit logs</span>
        </div>
      </div>
      ...
      <div class="feat">
        ...
        <p class="feat-desc">Dedicated instance for government and regulated industries. Custom threat policy engine, ICBC constitutional alignment, MENA-sovereign architecture, full audit trail, SLA guarantee. Built for high-stakes autonomous systems.</p>
        <div class="feat-tags">
          <span class="ftag">self-hosted</span>
          <span class="ftag">custom rules</span>
          <span class="ftag">ICBC aligned</span>
          <span class="ftag">SLA</span>
        </div>
      </div>
    </div>
  </div>
...
<section class="compare-section" id="compare">
  ...
  <table class="compare-table reveal">
    ...
    <tbody>
      <tr>
        <td>Pre-execution blocking</td>
        <td class="tc"><span class="cy">✅ Yes</span></td>
        <td><span class="cn">❌ Post-commit only</span></td>
        <td><span class="cn">❌ Post-commit only</span></td>
        <td><span class="cn">❌</span></td>
      </tr>
      <tr>
        <td>Telegram-native UX</td>
        <td class="tc"><span class="cy">✅ Yes</span></td>
        <td><span class="cn">❌</span></td>
        <td><span class="cn">❌</span></td>
        <td><span class="cn">❌</span></td>
      ...
      <tr>
        <td>Free tier (no signup)</td>
        <td class="tc"><span class="cy">✅ 5 free scans</span></td>
        <td><span class="cn">❌</span></td>
        <td><span class="cp">⚠️ Limited</span></td>
        <td><span class="cn">❌ Enterprise only</span></td>
      </tr>
      <tr>
        <td>Shell command scanning</td>
        <td class="tc"><span class="cy">✅ Yes (R01–R08)</span></td>
        <td><span class="cn">❌</span></td>
        <td><span class="cn">❌</span></td>
        <td><span class="cp">⚠️ Limited</span></td>
      </tr>
      <tr>
        <td>Dependency CVE audit</td>
        <td class="tc"><span class="cy">✅ Builder+</span></td>
        <td><span class="cy">✅</span></td>
        <td><span class="cy">✅</span></td>
        <td><span class="cy">✅</span></td>
      </tr>
      <tr>
        <td>CI/CD pipeline scan</td>
        <td class="tc"><span class="cy">✅ Yes</span></td>
        <td><span class="cp">⚠️ Partial</span></td>
        <td><span class="cp">⚠️ Partial</span></td>
        <td><span class="cy">✅</span></td>
      </tr>
      <tr>
        <td>MENA sovereign focus</td>
        <td class="tc"><span class="cy">✅ Yes</span></td>
        <td><span class="cn">❌</span></td>
        <td><span class="cn">❌</span></td>
        <td><span class="cn">❌</span></td>
...
<section class="sovereign-section">
  ...
  <div class="sovereign-metrics reveal">
    <div class="smet">
      <div class="smet-n">75+</div>
      <div class="smet-l">Countries in community</div>
    </div>
    <div class="smet">
      <div class="smet-n">528</div>
      <div class="smet-l">Community members</div>
    </div>
    <div class="smet">
      <div class="smet-n">3</div>
      <div class="smet-l">Active scan engines</div>
    </div>
    <div class="smet">
      <div class="smet-n">v2.0</div>
      <div class="smet-l">Engine — production stable</div>
    </div>
  </div>
</section>
  ...
  <div class="pricing-inner">
    ...
    <div class="pricing-grid reveal">
      ...
      <div class="plan">
        ...
        <div class="plan-price">
          <span class="price-n">$9</span>
          <span class="price-p">/month</span>
        </div>
    ...
    <div class="enterprise-row reveal">
      <div>
        ...
        <p class="ent-p">Dedicated deployment · Custom policy engine · Audit logs · MENA sovereign architecture · ICBC constitutional alignment · Unlimited scans · Self-hosted option</p>
      </div>
  ...
  <div class="roadmap-inner">
    ...
    <div class="roadmap-grid reveal">
      ...
      <div class="rm-card">
        ...
        <div class="rm-title">GitHub App + Webhook Alerts</div>
        <p class="rm-desc">Auto-scan on push. BLOCK alerts in Telegram when threats are detected in your repo commits.</p>
      </div>
      <div class="rm-card">
        <div class="rm-q">Q3 2026</div>
        <div class="rm-title">Policy Engine UI + Custom Rules</div>
        <p class="rm-desc">Enterprise self-service. Define your own threat rules, thresholds, and response actions per organization.</p>
      </div>
      <div class="rm-card">
        <div class="rm-q">Q4 2026</div>
        <div class="rm-title">Sovereign Deployment Option</div>
        <p class="rm-desc">Dedicated instance for government and regulated industries. Full audit trail. MENA sovereign architecture.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="final-cta">
  ...
  <div class="final-btns">
    ...
    <a href="mailto:ayman@teosegypt.com" class="btn-secondary">Enterprise inquiry →</a>
  </div>
</section>
...
<footer>
  <div class="footer-inner">
    ...
    <div class="foot-col">
      <h5>Enterprise</h5>
      <ul>
        <li><a href="mailto:ayman@teosegypt.com">Request Pilot</a></li>
        <li><a href="https://github.com/Elmahrosa/Teos-International-Civic-Blockchain-Constitution">ICBC Constitution</a></li>
        <li><a href="https://github.com/Elmahrosa/teos-sovereign-security-stack">Full Stack</a></li>
        <li><a href="https://teos-sentinel-shield.vercel.app/">Vercel (v2)</a></li>
      </ul>
    </div>
  </div>
